    ...
    <div>
      ...
      <section style={{ background: '#0a0a0a', position: 'relative', overflow: 'hidden',
        ...
        <div style={{
          ...
          fontFamily: 'Syne, sans-serif', fontSize: 'clamp(80px, 20vw, 280px)',
        ...
        <div style={{ maxWidth: '1280px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{ fontFamily: 'Syne, sans-serif', fontSize: 'clamp(2.6rem, 9vw, 6.5rem)', fontWeight: 800, color: '#fff', letterSpacing: '-0.04em', lineHeight: 0.95, maxWidth: '700px' }}>
            Built to serve.<br />
            <span style={{ color: 'transparent', WebkitTextStroke: '1.5px rgba(255,255,255,0.4)' }}>Made in Rwanda.</span>
          </h1>
        </div>
      </section>
          ...
          <div className="mission-grid">
            ...
            <div data-reveal="left">
              <div style={{ fontFamily: 'Syne, sans-serif', fontSize: '0.7rem', fontWeight: 600, letterSpacing: '0.2em', textTransform: 'uppercase', color: '#9b9b9b', display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
                <span style={{ width: '28px', height: '1px', background: '#9b9b9b' }} />Our Mission
              </div>
              <h2 style={{ fontFamily: 'Syne, sans-serif', fontSize: 'clamp(1.6rem, 3.5vw, 2.5rem)', fontWeight: 800, color: '#0a0a0a', letterSpacing: '-0.03em', lineHeight: 1.05, marginBottom: '1.5rem' }}>
            ...
            <div data-reveal="right">
              <div style={{ fontFamily: 'Syne, sans-serif', fontSize: '0.7rem', fontWeight: 600, letterSpacing: '0.2em', textTransform: 'uppercase', color: '#9b9b9b', display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
                <span style={{ width: '28px', height: '1px', background: '#9b9b9b' }} />Our Vision
              </div>
              <h2 style={{ fontFamily: 'Syne, sans-serif', fontSize: 'clamp(1.6rem, 3.5vw, 2.5rem)', fontWeight: 800, color: '#0a0a0a', letterSpacing: '-0.03em', lineHeight: 1.05, marginBottom: '1.5rem' }}>
                A digital Africa
              </h2>
      ...
      <section className="section-pad" style={{ backgroundColor: '#0a0a0a' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          <div data-reveal style={{ marginBottom: '4rem', borderBottom: '1px solid rgba(255,255,255,0.08)', paddingBottom: '3rem' }}>
            <div style={{ fontFamily: 'Syne, sans-serif', fontSize: '0.7rem', fontWeight: 600, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.3)', display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
              <span style={{ width: '28px', height: '1px', background: 'rgba(255,255,255,0.3)' }} />What Drives Us
            </div>
          ...
          <div className="values-grid">
            {[
              ...
              <div key={v.title} className="values-cell" data-reveal style={{ transitionDelay: `${i * 0.08}s` }}
                onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = 'rgba(255,255,255,0.03)' }}
                onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = 'transparent' }}
              >
                <div style={{ fontFamily: 'Syne, sans-serif', fontSize: '0.65rem', fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.25)', marginBottom: '1.25rem' }}>
                  {v.num}
                </div>
                <h3 style={{ fontFamily: 'Syne, sans-serif', fontSize: '1.05rem', fontWeight: 700, color: '#fff', letterSpacing: '-0.01em', marginBottom: '0.75rem' }}>
                  {v.title}
                </h3>
                <p style={{ fontSize: '0.82rem', color: 'rgba(255,255,255,0.4)', lineHeight: 1.75 }}>{v.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* CTA */}
      <section className="section-pad" style={{ backgroundColor: '#f5f4f0', textAlign: 'center' }}>
        <div data-reveal style={{ maxWidth: '600px', margin: '0 auto' }}>
          <div style={{ fontFamily: 'Syne, sans-serif', fontSize: '0.7rem', fontWeight: 600, letterSpacing: '0.2em', textTransform: 'uppercase', color: '#9b9b9b', marginBottom: '1.5rem' }}>
            Work With Us
          </div>
          <h2 style={{ fontFamily: 'Syne, sans-serif', fontSize: 'clamp(1.8rem, 5vw, 3rem)', fontWeight: 800, color: '#0a0a0a', letterSpacing: '-0.04em', lineHeight: 1, marginBottom: '1.5rem' }}>
