    ...
    <section style={{
      ...
      <div style={{
        ...
        <div className="animate-fade-up" style={{
          ...
          <span style={{ width: '36px', height: '1px', background: 'rgba(255,255,255,0.3)' }} />
        ...
        <div className="animate-fade-up" style={{
          ...
          {[
            ...
            <div key={s.l}>
              <div style={{ fontFamily: 'Syne, sans-serif', fontSize: '1.6rem', fontWeight: 800, color: '#fff', letterSpacing: '-0.03em' }}>{s.n}</div>
              <div style={{ fontFamily: 'Syne, sans-serif', fontSize: '0.65rem', fontWeight: 600, letterSpacing: '0.15em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.35)', marginTop: '0.1rem' }}>{s.l}</div>
            </div>
          ))}
        </div>
      </div>
