...
const STEPS = [
  ...
  { num: '02', title: 'We plan & quote',        desc: 'We review your brief and send a clear, honest quote with timeline. No hidden costs, no ambiguity.' },
  { num: '03', title: 'We build it',            desc: 'Our team gets to work. You receive updates at every stage and can request revisions freely.' },
  { num: '04', title: 'Delivery & support',     desc: 'Your finished project is handed over. We stay available for any questions, fixes or follow-ups.' },
]
        ...
        <div className="process-grid">
          {STEPS.map((step, i) => (
            <div key={step.num} className="process-cell" data-reveal style={{ transitionDelay: `${i * 0.1}s` }}>
              <div style={{ fontFamily: 'Syne, sans-serif', fontSize: '0.65rem', fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#9b9b9b', marginBottom: '2rem' }}>
                {step.num}
              </div>
